...
urlpatterns = [
    ...
    path('remove/<str:id>/', views.RemoveMemberFromGroupView.as_view(), name = 'leave-group'), # ID: MEMBER ID
    path('delete/<str:id>/', views.DeleteGroupView.as_view(), name = 'delete-group'),
